...
def test_get_controller_version():
    ...
    assert get_controller_version(17838105) == (Controller.C6, 1, 1, 3, 25)
    assert get_controller_version(18886683) == (Controller.C6, 1, 2, 3, 27)
    assert get_controller_version(17838114) == (Controller.C6, 1, 1, 3, 34)
    assert get_controller_version(17846317) == (Controller.C6, 1, 1, 5, 45)
    assert get_controller_version(34607113) == (Controller.C6, 2, 1, 1, 9)
