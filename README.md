...
| `pyproject.toml`                | Python project metadata and dependencies used for development/lint/testing this integration.                           | [Documentation](https://packaging.python.org/en/latest/guides/writing-pyproject-toml/)                                         |
| `uv.lock`                       | Lock file for reproducible dependency installations using uv.                                                           | [Documentation](https://docs.astral.sh/uv/)                                                                                    |
